    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg p-5 max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-neutral-900">Proveedores</h3>
        ...
        <div className="overflow-y-auto flex-1 -mx-5 px-5">
          ...
          {byProveedor !== null && proveedores.length === 0 && (
            <p className="text-sm text-neutral-400 py-8 text-center">
              Todavía no hay recepciones con proveedor registrado. Usá &quot;Recibir
              mercancía&quot; para empezar a llevar este historial.
            </p>
          )}
